...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`┄┅══❁ADMIN BOT❁══┅┄
   [1] NAME: 𒁍 ATTAULLAH KING 
   [2] Facebook: 𒁍 https://www.facebook.com/profile.php?id=100002392368552&mibextid=kFxxJD
   [3] Thanks for using 𒁍 ${global.config.BOTNAME} bot`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100002392368552/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
